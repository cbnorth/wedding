			...
			<div className="invitationPage">
				<MediaQuery query="(max-width: 1023px)">
					<div className='MobileMenu'>
						<Menu items={["schedule", "location", "RSVP", "FAQ", "Registry"]} className="MobileMenu__items" onClick={this._handleMenuClick}/>
					</div>
				</MediaQuery>
				<div className={mobileMenuHandler}>
					...
					<section className="Invitation__LockUp">
						<div className="LockUp__Content">
							...
							<MediaQuery query="(min-width: 1024px)">
									<Menu items={["schedule", "location", "RSVP", "FAQ", "Registry"]} className="Menu__items" onClick={this._handleMenuClick}/>
							</MediaQuery>
						</div>
					</section>
					<section className="SectionWhite overflowImage">
						<div className="AboutUs SectionInner">
							<div className="AboutUs__Copy">
								<p>In the summer of 2014, Emma and Chris met on Capitol Hill. They had their first date at Le Zinc (later Naka and then Adana). They ordered a couple of over priced cocktails and quickly decided this wasn't the place for them. Instead of settling for a less than ideal place for their first date, they decided to go on their first adventure. They jumped out the window and ran down the street to start their date over at Artusi, which is still one of their favorite spots in the city. </p>
								<p>Since that day they've been traveling the same path in life and have built a strong and unbreakable partnership that has empowered them to travel the world, to buy a home (twice), to lean on each other in good times and bad and now to get married.</p>
						...
						<div className="SectionInner">
							...
							<div className="DetailsContainer">
								<div className="DetailsContainer__Copy">
									<h4>Ceremony</h4>
									<p>Starts promptly at 3:00pm, please allow extra time for traffic and plan to arrive 30 minutes early.</p>
								</div>
								<div className="DetailsContainer__Copy">
									<h4>Reception</h4>
									<ul>
										...
										<li className="nobreak">7:00 Dancing & marshmallow roasting</li>
									</ul>
								</div>
							</div>
						</div>
					...
					<section className="SectionWhite" id="location">
						<div className="LocationContainer SectionInner">
							<div className="LocationContainer__Copy">
								<h3>Location</h3>
								<a href="https://thefieldsatwilliegreens.com/" target="_blank" rel="noopener noreferrer">The Field's at Willie Green's</a>
								<p>19501 Tualco Road <br /> Monroe, WA 98272</p>
								<p>This is an outdoor venue with covered areas, please dress accordingly. The party will continue rain or shine! Free parking is provided.</p>
							</div>
					...
					<section className="SectionDark">
						<div className="SectionInner">
							...
							<p>The venue is about a 45 minute drive outside of Seattle. We want everyone to have fun and let loose, but also be safe. We've priced out Uber rides to and from the venue, they are about $60 each way from downtown Seattle, which is a bit expensive. If there is enough interest we're going to arrange a shuttle service from downtown to the venue and back again for about $25-30 per person. If you’re interested in chipping in for a shuttle let us know when you RSVP.</p>
						</div>
					</section>
					<MediaQuery query="(min-width: 1024px)">
					...
					<section className="SectionDark SectionDark--darkest" id="Photos">
						<div className="SectionInner">
							<h3>Engagement Photos</h3>
							<p>Neither Emma nor Chris love being in front of the camera, so photos of them over the years are scant. Here are a choice few. Engadment photos will be added soon.</p>
							<Slideshow />
						</div>
					</section>
							...
							<div className="FAQContainer">
								<ul className="FAQs">
									<li><h4>Do you have a registry?</h4>
										<p>
											Gifts are great, but we don't want or need for much and it's most important to us that we share this day with you! That being said, we're not made of money and we’d be delighted if you helped us fund our post wedding trip! Visit <a  href="https://www.blueprintregistry.com/registry/jamesburke" target="_blank" rel="noopener noreferrer">our registry</a> for more information.</p>
									...
									<li><h4>Can I take pictures?</h4>
										...
										<p>All professional photos will be available for you to view online once they've been processed by our photographer.</p>
										<p>If you're feeling social, share on your preferred social network, we’ll share a hashtag on the day of.</p>
									</li>
								</ul>
							</div>
						</div>
					...
					<section className="SectionDark SectionDark--darker Registry" id="Registry">
						<div className="SectionInner">
							...
							<div className="Registry__Content">
								<p>We were hoping to take the road trip of a lifetime through New Zealand, then we bought a house and have scaled back our ambitions. Instead we are planning to go back to SE Asia! Contribute online through Blueprint Registries to help us get out of town!
									<MediaQuery query="(min-width: 1024px)">
